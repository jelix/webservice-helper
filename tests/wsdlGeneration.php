...
class testWsdlWithObject
{
     ...
     * @return void
     */
    public function meth1(testWsdlSimpleClass $arg1)
    {
    }
     ...
     * @return void
     */
    public function meth4(testWsdlSimpleClass $paramObj, $arr, $num, $str)
    {
    }
}
...
class wsdlGenerationTests  extends PHPUnit_Framework_TestCase
{
    ...
    public function testWsdlWithMixed()
    {
